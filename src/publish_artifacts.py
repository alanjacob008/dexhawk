...
"""
import argparse, os, shutil, datetime as dt, csv, json
...
def main(argv=None) -> int:
    ...
    ensure_dir(latest_dir); ensure_dir(daily_dir); ensure_dir(hist_dir)
    ...
    # append to history (from latest CSV we just staged)
    ...
    print(f"[publish] updated latest/, daily_snapshots/, history/")
    return 0
